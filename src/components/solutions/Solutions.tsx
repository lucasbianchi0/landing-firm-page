      ...
      <div className="gap-10 space-y-8 lg:space-y-0 mt-12 lg:grid lg:grid-cols-2 h-full ">
        ...
        {[
          ...
          >
            ...
            <figure className="drop-shadow-2xl h-[300px] w-auto bg-red-500 mt-5 relative aspect-[16/9]   lg:mx-0 transition-all duration-300 ease-in-out lg:aspect-none  lg:translate-x-3 lg:translate-y-8 lg:h-[85%] lg:w-auto lg:mt-auto lg:col-span-5 lg:group-hover:-translate-y-0">
              <Image
                src={item.image}
                alt={item.alt}
                className="filter:shadow-xl object-center lg:object-left w-full mx-auto p-3 md:p-0 h-full object-contain"
                fill
                sizes="100vh"
              />
            </figure>
