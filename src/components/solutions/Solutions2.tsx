    ...
    <section className="container sectionStyle">
      ...
      <div className="md:flex gap-10 mt-12">
        {[
          ...
          <article
            key={index}
            className="w-full relative !border-3 bg-violet-500 border-black shadow-xl overflow-hidden rounded-2xl h-[400px] group transition-all duration-300 ease-in-out transform hover:scale-105 hover:filter hover:border-2 md:hover:border-blue-700/20 md:hover:shadow-2xl md:hover:shadow-blue-700/40"
          >
