    ...
    >
      ...
      {industrySection ?
        <h2 className="text-4xl md:text-5xl font-medium text-white flex flex-col w-full">
          Especialistas en <span className="pb-1 custom-gradient-text font-bold  w-full bg-gradient-to-r from-blue-600 to-blue-800 inline-block text-transparent bg-clip-text">{title}</span>
        </h2>
        :
