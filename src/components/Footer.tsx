...
const Footer = () => {
  return (
    <div>
      <footer className="relative bg-[#000F2D] z-10 py-8 md:py-16">
          ...
          <div className="md:flex md:justify-between ">
              ...
              <ul className="flex justify-center gap-6 mt-8 sm:justify-start md:gap-8">
                <li>
                  <a
                    ...
                    rel="noreferrer"
                    target="_blank"
                    className="text-[#62A2FF] transition hover:text-teal-700/75"
                  >
            ...
            <div className="mt-10 md:mt-0 inline-block w-[50%] align-top text-left  md:w-auto md:text-center ">
              ...
              <ul className="mt-8 space-y-4 text-sm">
                <li>
                  <a
                    className="text-[#62A2FF] transition hover:text-gray-700/75"
                    href="#"
                  >
                    Web Development
                  </a>
              ...
              <ul className="mt-8 space-y-4 text-sm">
                ...
                <li>
                  ...
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="size-5 shrink-0 text-[#62A2FF]"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      strokeWidth="2"
